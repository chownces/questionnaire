...
from api.serializers import SubmissionReadSerializer, SubmissionWriteSerializer
...
class SubmissionTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.questions = [
            QuestionFactory.create(
                form_id=cls.form, display_order=i, question_type=cls.question_types[i]
            )
            for i in range(cls.num_questions_default)
        ]

        cls.submission1 = SubmissionFactory(form_id=cls.form)
        cls.submission2 = SubmissionFactory(form_id=cls.form)
        cls.answers1 = [
    ...
    # - Handles form_id does not exist
